...
const BUTTON_CLASS =
  'flex h-7 w-7 items-center justify-center rounded bg-[#4d4d4d] text-gray-300 hover:bg-[#666666] hover:text-[#4f8fd6]'
  ...
  return (
    <>
      ...
      <button
        type="button"
        aria-label="F11"
        className={`flex h-7 w-7 items-center justify-center rounded bg-[#4d4d4d] hover:bg-[#666666] hover:text-[#4f8fd6] ${
          isNativeFullscreen ? 'text-[#4f8fd6]' : 'text-gray-300'
        }`}
