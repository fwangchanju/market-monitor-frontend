    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/70" onClick={onClose}>
      ...
      >
        ...
        <div className="mt-4 grid shrink-0 grid-cols-3 items-center gap-4">
          ...
          {isCopying ? (
            <p className="nes-btn col-start-2 flex h-9 w-48 items-center justify-center gap-2 border-gray-600 bg-black px-3 py-1.5 text-sm text-white shadow-lg">
            ...
            showCopiedNotice && (
              <button
                type="button"
                onClick={onCopy}
                className="nes-btn col-start-2 flex h-9 w-48 items-center justify-center gap-2 border-[var(--accent)] bg-[var(--accent)] px-3 py-1.5 text-black shadow-lg hover:bg-[var(--accent-hover)]"
              >
